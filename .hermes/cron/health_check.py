...
class CronJob:
    ...
    def __init__(self, raw: dict[str, Any]) -> None:
        ...
        if schedule.get("kind") == "interval":
            ...
            # For cron-based jobs, use default intervals based on cron expression
            cron_expr = schedule.get("expr", schedule.get("display", ""))
            self.minutes = self._infer_interval_from_cron(cron_expr)
