...
Every closed pilot cycle (and at minimum a monthly review) runs through the bounded retrospective step defined in [ADR-0010](../decisions/0010-retrospective-learning-loop.md) and operationalized in [`retrospective-learning-loop.md`](retrospective-learning-loop.md). In summary:
