...
- Related ADRs: `0001-use-perplexity-linear-and-github-as-control-plane.md`, `0003-linear-persistence-boundary.md`, `0004-process-docs-vs-agent-skills.md`, `0005-linear-dependency-and-sequencing-model.md`, `0006-agent-run-visibility-schema.md`, `0007-qa-review-evidence-workflow.md`, `0008-agent-control-layer-and-perplexity-boundary.md` (which uses the older "ACL" name for the same substrate), `0013-icp-state-persistence-and-telemetry.md` (pins the run recorder's MVP destination to the repo-committed `runs/` tree and names the visibility query surfaces).
