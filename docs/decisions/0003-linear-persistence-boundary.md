...
- Linear: `LAT-9`, `LAT-12`.
- Related ADRs: `0001-use-perplexity-linear-and-github-as-control-plane.md`, `0002-store-process-docs-and-adrs-in-the-monorepo.md`, `0004-process-docs-vs-agent-skills.md`, `0014-icp-state-persistence-and-telemetry.md` (MVP run-registry destination and visibility query surfaces).
