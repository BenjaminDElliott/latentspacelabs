...
function controlLoopSummary(
  ...
  return {
    ...
    evidence: {
      ...
      checks: [
        { name: "build", command: "npm run build", outcome: "passed", durationMs: 120, kind: "shell" },
      ],
      refusals: [],
...
function harnessSummary(
  ...
  return {
    ...
    checkPlan: [
      ...
      { name: "no-forbidden", command: "No edits under forbidden paths.", source: "ticket-pack", kind: "policy" },
    ],
    refusals: [],
    ...overrides,
  };
